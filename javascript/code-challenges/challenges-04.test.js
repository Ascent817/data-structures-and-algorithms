  ...
  if (a.lastName > b.lastName) {
    ...
    if (a.firstName > b.firstName) {
      ...
      if (a.age > b.age) {
        ...
        throw 'I give up both people are the exact same.';
      }
    }
  }
});
...
const sortMeetingsByDay = (arr) => {
  ...
  return arr.sort((a, b) => dict[a.dayOfWeek] < dict[b.dayOfWeek] ? -1 : 1);
};
...
const sortSchedule = (arr) => {
  ...
  return arr.sort((a, b) => {
    if (dict[a.dayOfWeek] < dict[b.dayOfWeek]) {
      return -1;
    } else if (dict[a.dayOfWeek] > dict[b.dayOfWeek]) {
      return 1;
    } else {
