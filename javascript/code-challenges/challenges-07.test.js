...
const removeThree = (idx, arr) => {
  return [...arr.slice(0, idx), ...arr.slice(idx + 3)];
};
...
const listFoods = (recipe) => recipe.ingredients.map((ing) => {
  let newStr = ing;
  let space = newStr.indexOf(' ');
  newStr = newStr.slice(space + 1);
  space = newStr.indexOf(' ');
  newStr = newStr.slice(space + 1);
  return newStr;
});
...
const splitFoods = (recipe) => recipe.ingredients.map((food) => food.split(' ').slice(2).join(' '));
...
const stepActions = (recipe) => recipe.steps.map((food) => food.split(' ')[0]);
...
const totalSumCSV = (str) => str.split(',').map((num) => parseInt(num)).reduce((a, b) => a + b);
...
const removeVowels = (str) => str.split('').filter((char) => !(char === 'A' || char === 'E' || char === 'I' || char === 'O' || char === 'U' || char === 'a' || char === 'e' || char === 'i' || char === 'o' || char === 'u')).join('');
...
const extractVowels = (str) => [str.split('').filter((char) => !(char === 'A' || char === 'E' || char === 'I' || char === 'O' || char === 'U' || char === 'a' || char === 'e' || char === 'i' || char === 'o' || char === 'u')).join(''), str.split('').filter((char) => (char === 'A' || char === 'E' || char === 'I' || char === 'O' || char === 'U' || char === 'a' || char === 'e' || char === 'i' || char === 'o' || char === 'u')).sort().join('')];
